...
export default function QuoteAcceptButton({
  ...
  return (
    <>
      ...
      <Modal isOpen={open} onClose={() => setOpen(false)} title={t("quoteAccept_modalTitle", { name: providerName })} size="sm">
        <div className="p-6 space-y-4">
          ...
          <div className="rounded-lg border border-slate-200 overflow-hidden text-sm">
            <div className="flex justify-between px-4 py-2.5 bg-slate-50">
              <span className="text-slate-500">{t("quoteAccept_amount")}</span>
            ...
            <div className="flex justify-between px-4 py-2.5 border-t border-slate-100">
              <span className="text-slate-500">{t("quoteAccept_platformFee", { rate: (breakdown.rate * 100).toFixed(0) })}</span>
            ...
            <div className="flex justify-between px-4 py-2.5 border-t border-slate-100 bg-slate-50">
              <span className="text-slate-600">{t("quoteAccept_providerEarns")}</span>
          ...
          <div className="flex gap-3 pt-1">
            ...
            >
              {loading ? t("quoteAccept_confirming") : t("quoteAccept_confirmBtn")}
            </button>
          </div>
        </div>
      </Modal>
