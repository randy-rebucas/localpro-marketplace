      ...
      <aside className="w-72 shrink-0 flex flex-col border-r border-slate-200 overflow-hidden">
        ...
        {threads.length === 0 ? (
          <div className="flex-1 flex flex-col items-center justify-center gap-2 text-slate-400 px-6 text-center">
            ...
            <p className="text-xs">No conversations yet. Messages appear once a provider is assigned to your job.</p>
          </div>
        ) : (
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center justify-between gap-1 mb-0.5">
                        ...
                        {t.unreadCount > 0 && (
                          <span className="inline-flex items-center justify-center h-4.5 min-w-[18px] px-1 rounded-full bg-primary text-white text-[10px] font-bold shrink-0">
                            {t.unreadCount}
                          </span>
                        )}
                      </div>
