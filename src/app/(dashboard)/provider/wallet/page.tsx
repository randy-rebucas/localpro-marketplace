...
import WalletWithdrawForm from "@/app/(dashboard)/client/wallet/_components/WalletWithdrawForm";
import WalletTopUpForm from "@/app/(dashboard)/client/wallet/_components/WalletTopUpForm";
import WalletTopUpConfirm from "@/app/(dashboard)/client/wallet/_components/WalletTopUpConfirm";
import WalletLedgerTable from "@/app/(dashboard)/client/wallet/_components/WalletLedgerTable";
import WalletWithdrawalList from "@/app/(dashboard)/client/wallet/_components/WalletWithdrawalList";
    ...
    <div className="space-y-8">
      ...
      <div>
        ...
        <p className="text-slate-500 text-sm mt-1">
          Top up your balance to pay for featured listings, lead fees, and training courses, or withdraw your available funds to your bank.
        </p>
      </div>
